...
public class FastDFSClient {
	 ...
	 * @return
	 */
	public static String uploadFile(InputStream is, String fileName,HttpServletRequest request) throws IOException,MyException{
		String client=null;
		byte[] buff=null;
...
//		client=storageClient1.upload_file1(buff,getFileExt(fileName),meta_list);
		...
		client =context.getRealPath(UUID.randomUUID().toString());
		FileOutputStream out= new FileOutputStream(client);
		out.write(buff);
		out.flush();
		out.close();
		return  client;
